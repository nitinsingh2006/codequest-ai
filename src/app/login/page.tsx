  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="card-cyber w-full max-w-md">
        <h1 className="text-3xl font-display font-bold text-center mb-2">⚔️ CodeQuest AI</h1>
        <p className="text-center text-gray-400 mb-8">Login to continue your adventure</p>

        {/* OAuth Buttons */}
        <div className="space-y-3 mb-6">
          <button
            onClick={() => signIn("github", { callbackUrl: "/dashboard" })}
            className="w-full flex items-center justify-center gap-3 bg-[#24292f] hover:bg-[#2f363d] text-white font-medium px-4 py-3 rounded-xl transition-colors"
          >
